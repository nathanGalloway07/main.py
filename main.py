...
#11/4/21
#gym needs/goals
#i am designing a program that is ment for intense powerlifing/ body builders.
#this program will inform this lifters what they should take, when to take it and
#giving them fitness facts. the program is welcome to all fitness levels as long
#as they are not 100% in to resestance training.
print("section 1")
...
print("hi",name,"we will determine your fitness info shortly", sep=' ')
...
#this section above uses variables and if else statemetns to asses what the user
#should take. it is simple now, but a work in progress.
print("section 2")
print("this next section is going to be imormative about fitness supplaments")
print("these next questions you will be given the answers too for a better understanding")
print("true or false. Are whey and isolate protein the same diet wise", end='?')
...
print("true of false. Both whey and isolate are fast absorbing proteins", end='.')
print(bool(whey1 == isolate1))
eleca = True
amino = not False
print("true of false. electralights hydrate and aminos recover your body", end='.')
print(bool(eleca and amino))
print("true or false. creatine increases atp or pre workout muscle growth", end='.')
preworkout = False
creatine = True
...
#section two uses bool to feed information in a more interaftive way rather then
#just a list of print statements
print("section 3")
...
print("how many minutes do you take your supplaments before your workout", end='?')
pretime = input()
...
#section 4 uses 4 loops to get the user to understand how early they should take
#pre gym supplamets before attending the gym.
print("section 5, thanks")
def greet(name, thanks="thanks for learing fitness facts with us, hope to see "
                       "you soon when updated!"):
    print("hey!", name + ',' + thanks)
greet(name)
print("section 6")
print("links that helped me")
#section 5 is the ending section used to greet and thankthe user for attending
#
...
#but becasue i was on my own i had to do trial an error untill i got it ot work
